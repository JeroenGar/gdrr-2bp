...
3. Run a short fixed-iteration debug solver on the small fixture so debug assertions exercise structural and cache invariants. Do not use the large fixture here: independently rebuilding the insertion cache after every mutation takes several minutes even for three iterations.
